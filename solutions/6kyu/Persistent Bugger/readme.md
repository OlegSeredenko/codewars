На вход подается целое число. Задача - умножать цифры, из которых составлено это чило, друг на друга до тех пор, пока число не станет из одной цифры (нужно подсчитать количество таких циклов).
